...
class Experiment:
    def __init__(self, encoder_input_vocab_size: int, decoder_input_vocab_size: int, embedding_size, ff_hidden_layer, source_tokenizer, target_tokenizer=None, head=6, dropout=None, N=6):
        ...
        self.criterion = torch.nn.CrossEntropyLoss(label_smoothing=0.1, ignore_index=source_tokenizer.token_to_id('[PAD]'))
        # TODO(use config.yaml to device value)
        self.device = 'cpu'
